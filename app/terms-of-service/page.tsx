  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <TextLayout title="Terms of Service">
        ...
        <List 
          items={[
            <span key="service"><strong>Service</strong> refers to the Website.</span>,
            <span key="terms"><strong>Terms</strong> refer to these Terms of Service.</span>,
            <span key="user"><strong>User</strong> refers to the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</span>,
            <span key="website"><strong>Website</strong> refers to The Comic DB, accessible from www.thecomicdb.com</span>,
            <span key="you"><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</span>
          ]}
        />
        ...
        <Paragraph>
          ...
          the exclusive property of The Comic DB and its licensors. The Service is protected by copyright, trademark, and other laws 
          of both the United States and foreign countries. Our trademarks and trade dress may not be used in connection with any 
          product or service without the prior written consent of The Comic DB.
        </Paragraph>
        ...
        <Paragraph>
          ...
          the Service infringes on the copyright or other intellectual property rights of any person or entity.
        </Paragraph>
        ...
        <Paragraph>
          ...
          in a way that constitutes copyright infringement, please submit your claim via email to dmca@thecomicdb.com, with the 
        ...
        <Paragraph>
          In no event shall The Comic DB, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental, special, consequential or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses, resulting from:
        </Paragraph>
        <List 
          items={[
        ...
        <Paragraph>
          The Comic DB, its subsidiaries, affiliates, and its licensors do not warrant that a) the Service will function uninterrupted, secure or available at any particular time or location; b) any errors or defects will be corrected; c) the Service is free of viruses or other harmful components; or d) the results of using the Service will meet your requirements.
        </Paragraph>
